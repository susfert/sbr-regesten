...
basic idea of MVC is to divide application logic into three layers.
...
browser. This page includes a full error trace-back containing
...
as well as using alternative testing frameworks, consult the
...
\item Every entity represented by a model class has to have a unique
  ...
  the common super class of the models shown in the diagram, it is not
...
arrows are super classes of classes with outgoing arrows; super
classes pass their attributes on to their subclasses. Relationships
between different types of models (\emph{associations}) are denoted by
black lines connecting their boxes. These lines are annotated with
